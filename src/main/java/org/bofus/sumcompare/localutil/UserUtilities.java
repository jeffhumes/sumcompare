...
public class UserUtilities {
	public static boolean getUserAcceptance() {
		...
		System.out.println(
				"-----------------------------------------------------------------------------------------------------------------------------\r\n");
		System.out.println(
				"NOTE: Please ensure you have created backups of the source and destination prior to running this\r\n");
		...
		if (userInput.equalsIgnoreCase("YES")) {
			...
			System.out.println(
					String.format("You answered %s to the acceptance, this process will terminate now", userInput));
			System.exit(99);
		}
		return returnValue;
	}
